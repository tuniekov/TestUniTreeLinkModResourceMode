<?php
$testunitreelinkmodresourcemode = $modx->getService('testunitreelinkmodresourcemode', 'testunitreelinkmodresourcemode', MODX_CORE_PATH . 'components/testunitreelinkmodresourcemode/model/', []);

$testunitreelinkmodresourcemode->pdo->setConfig([
    'class'=>'modResource',
    'parents'=>'0',
    'showUnpublished'=>1,
    'sortby'=>[
...
$ress = $testunitreelinkmodresourcemode->pdo->run();
foreach($ress as $res){
