...
class TestUniTreeLinkModResourceMode
{
    /** @var modX $modx */
    public $modx;
    ...
    {
        $this->modx =& $modx;
        $corePath = MODX_CORE_PATH . 'components/testunitreelinkmodresourcemode/';
        // $assetsUrl = MODX_ASSETS_URL . 'components/testunitreelinkmodresourcemode/';
        ...
        $this->modx->addPackage('testunitreelinkmodresourcemode', $this->config['modelPath']);
        $this->gtsShop = $modx->getService("gtsShop","gtsShop",
            MODX_CORE_PATH."components/gtsshop/model/",[]);
        //$this->modx->lexicon->load('testunitreelinkmodresourcemode:default');
